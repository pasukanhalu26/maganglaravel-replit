...
<?php $__env->startSection('header', 'Tambah Klaster'); ?>
    ...
    <div class="col-md-8">
        <div class="modern-form-card">
            <div class="modern-form-header d-flex justify-content-between align-items-center">
                ...
                <a href="<?php echo e(route('klaster.index')); ?>" class="btn btn-sm btn-light text-green rounded-pill px-3 shadow-sm"><i class="fas fa-arrow-left me-1"></i> Kembali</a>
            </div>
            <div class="modern-form-body">
                <form action="<?php echo e(route('klaster.store')); ?>" method="POST">
                    <?php echo csrf_field(); ?>
                    ...
                    <div class="row g-3">
                        <div class="col-md-6">
                            <a href="<?php echo e(route('klaster.index')); ?>" class="btn-modern-cancel">Batal</a>
                        </div>
                        <div class="col-md-6">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\maganglaravel\resources\views/klaster/create.blade.php ENDPATH**/ ?>