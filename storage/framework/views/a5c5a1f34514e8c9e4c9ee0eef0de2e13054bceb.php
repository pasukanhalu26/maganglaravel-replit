<?php $__env->startSection('header', 'Laporan Capaian'); ?>
            ...
            <form id="filterForm" class="row g-3">
                ...
                <div class="col-md-2">
                    ...
                    <select id="bulan_sampai" name="bulan_sampai" class="form-select">
                        <?php for($i=1; $i<=12; $i++): ?>
                            <option value="<?php echo e($i); ?>" <?php echo e($i == 12 ? 'selected' : ''); ?>><?php echo e(date('F', mktime(0, 0, 0, $i, 10))); ?></option>
                        <?php endfor; ?>
                    </select>
                </div>
                <div class="col-md-6">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\maganglaravel\resources\views/capaian/laporan_baru.blade.php ENDPATH**/ ?>