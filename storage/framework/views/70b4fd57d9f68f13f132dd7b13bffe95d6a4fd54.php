<?php $__env->startSection('header', 'Data Capaian'); ?>
    ...
    <div class="card border-0 shadow-sm rounded-4 mb-4">
        <div class="card-header bg-white py-4 border-0 d-flex justify-content-between align-items-center">
            ...
            <div class="d-flex gap-2">
                <a href="<?php echo e(route('capaian.import')); ?>" class="btn btn-outline-success rounded-pill px-4 shadow-sm fw-bold border-2">
                    <i class="fas fa-file-excel me-2"></i> Import Excel
                </a>
                <a href="<?php echo e(route('capaian.create')); ?>" class="btn btn-success rounded-pill px-4 shadow-sm fw-bold">
        ...
        <div class="card-body p-4 pt-0">
            <div class="row mb-4 align-items-center">
                <div class="col-md-6">
                    <form action="<?php echo e(route('capaian.index')); ?>" method="GET">
                        <div class="input-group bg-light rounded-pill p-1 shadow-sm border">
                            ...
                            <input type="text" name="katakunci" class="form-control bg-transparent border-0" placeholder="Cari Indikator, Desa, atau ID..." value="<?php echo e(Request::get('katakunci')); ?>">
                        ...
                        <?php if($currentBulan != $bulanStr): ?>
                            <tr class="bg-success bg-opacity-10">
                                <td colspan="8" class="fw-bold text-success py-2 ps-4" style="font-size: 0.75rem; letter-spacing: 1px;">
                                    <i class="fas fa-calendar-alt me-2"></i> BULAN <?php echo e($bulanStr); ?>

                                </td>
                            </tr>
                            <?php $currentBulan = $bulanStr; ?>
                        <?php endif; ?>

                        <tr class="bg-white">
                            <td class="ps-4">
                                <span class="badge bg-light text-dark border px-2">#<?php echo e($item->id_capaian); ?></span>
                            </td>
                            <td>
                                <div class="fw-bold text-dark mb-0 small"><?php echo e($item->target->klaster->nama_klaster ?? '-'); ?></div>
                                <div class="text-muted" style="font-size: 0.7rem;"><?php echo e($item->target->program->nama_program ?? '-'); ?></div>
                            </td>
                            <td>
                                <div class="text-dark small" style="max-width: 250px; overflow: hidden; text-overflow: ellipsis; white-space: nowrap;" title="<?php echo e($item->target->indikator->nama_indikator ?? '-'); ?>">
                                    <?php echo e($item->target->indikator->nama_indikator ?? '-'); ?>

                                </div>
                            </td>
                            <td class="text-center">
                                <span class="fw-bold text-dark"><?php echo e(number_format($target)); ?></span>
                            </td>
                            <td class="text-center">
                                <div class="badge bg-white text-success border border-success border-opacity-25 px-2"><?php echo e($bulanStr); ?></div>
                                <div class="text-muted mt-1" style="font-size: 0.65rem;">TAHUN <?php echo e($tahun); ?></div>
                            </td>
                            <td>
                                <span class="small fw-bold text-dark"><i class="fas fa-map-marker-alt text-danger me-1"></i> <?php echo e($item->desa->nama_desa ?? '-'); ?></span>
                            </td>
                            <td class="text-center">
                                <div class="fw-bold text-primary fs-5"><?php echo e(number_format($capaian_bulanan)); ?></div>
                            </td>
                            <td class="text-center">
                                <div class="dropdown">
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-end shadow border-0 rounded-3">
                                        <li><a class="dropdown-item py-2" href="<?php echo e(route('capaian.edit', $item->id_capaian)); ?>"><i class="fas fa-edit text-primary me-2"></i> Edit Data</a></li>
                                        <li><hr class="dropdown-divider opacity-25"></li>
                                        <li>
                                            <form action="<?php echo e(route('capaian.destroy', $item->id_capaian)); ?>" method="POST" class="d-inline form-delete">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\maganglaravel\resources\views/capaian/index.blade.php ENDPATH**/ ?>