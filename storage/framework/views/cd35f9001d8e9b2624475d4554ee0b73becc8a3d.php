<?php $__env->startSection('header', 'Edit Capaian'); ?>
    ...
    <div class="col-xl-10">
        <div class="card border-0 shadow-sm rounded-4 overflow-hidden mb-4">
            ...
            <div class="card-body p-5 bg-light">
                ...
                <form action="<?php echo e(route('capaian.update', $capaian->id_capaian)); ?>" method="POST">
                                ...
                                <div class="card-body p-4">
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <select id="filter_klaster" class="form-select form-select-lg rounded-3 shadow-sm border-0 bg-light" style="font-size:0.9rem">
                                            <?php $__currentLoopData = $klasters; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($k->id_klaster); ?>" <?php echo e($capaian->target->id_klaster == $k->id_klaster ? 'selected' : ''); ?>><?php echo e($k->nama_klaster); ?></option>
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <select id="filter_program" class="form-select form-select-lg rounded-3 shadow-sm border-0 bg-light" style="font-size:0.9rem">
                                            <?php if($capaian->target && $capaian->target->program): ?>
                                                <option value="<?php echo e($capaian->target->id_program); ?>" selected><?php echo e($capaian->target->program->nama_program); ?></option>
                                            <?php endif; ?>
                                        </select>
                                    </div>
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <select id="filter_indikator" class="form-select form-select-lg rounded-3 shadow-sm border-0 bg-light" style="font-size:0.9rem">
                                            <?php if($capaian->target && $capaian->target->indikator): ?>
                                                <option value="<?php echo e($capaian->target->id_indikator); ?>" selected><?php echo e($capaian->target->indikator->nama_indikator); ?></option>
                                            <?php endif; ?>
                                        </select>
                                    </div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select name="id_target" id="id_target" class="form-select form-select-lg rounded-3 shadow-sm border-success bg-white" style="font-size:0.9rem; border-width: 2px;" required>
                                            <?php if($capaian->target): ?>
                                                <option value="<?php echo e($capaian->id_target); ?>" selected><?php echo e($capaian->target->periode); ?> (Target: <?php echo e(number_format($capaian->target->target_tahunan)); ?>)</option>
                                            <?php endif; ?>
                                        </select>
                                    </div>
                                </div>
                            ...
                            <div class="card border-0 shadow-sm rounded-4 h-100">
                                <div class="card-body p-4">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <select name="id_desa" id="id_desa" class="form-select rounded-3 shadow-sm border-0 bg-light" style="font-size:0.9rem" required>
                                                <?php $__currentLoopData = $desas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $d): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option value="<?php echo e($d->id_desa); ?>" <?php echo e($capaian->id_desa == $d->id_desa ? 'selected' : ''); ?>><?php echo e($d->nama_desa); ?></option>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            </select>
                                        </div>
                                        <div class="col-md-6">
                                            ...
                                            <select name="bulan" class="form-select rounded-3 shadow-sm border-0 bg-light" style="font-size:0.9rem" required>
                                                ...
                                                <?php $__currentLoopData = $bulans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $num => $name): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option value="<?php echo e($num); ?>" <?php echo e($capaian->bulan == $num ? 'selected' : ''); ?>><?php echo e($name); ?></option>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            </select>
                                        </div>
                                    </div>
                                        ...
                                        <div class="row g-2 text-center">
                                            <div class="col-6">
                                                <div class="p-2 bg-white rounded-3 shadow-sm">
                                                    ...
                                                    <div id="info_target" class="fw-bold text-dark" style="font-size:1.1rem"><?php echo e($capaian->target ? number_format($capaian->target->target_tahunan, 0, ',', '.') : '-'); ?></div>
                                                </div>
                                            </div>
                                            <div class="col-6">
                                                <div class="p-2 bg-white rounded-3 shadow-sm border border-success">
                                                    ...
                                                    <div id="info_per_bulan" class="fw-bold text-success" style="font-size:1.1rem">± <?php echo e($capaian->target ? number_format(round($capaian->target->target_tahunan / 12), 0, ',', '.') : '-'); ?></div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <div class="input-group shadow-sm rounded-3">
                                            ...
                                            <input type="number" name="capaian_bulan" id="capaian_bulan" class="form-control border-0 text-center fw-bold text-primary"
                                                value="<?php echo e($capaian->capaian_bulan); ?>" placeholder="0" min="0" required style="font-size: 1.5rem; height: 60px;">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <textarea name="analisa_masalah" class="form-control rounded-3 border-0 shadow-sm bg-light" rows="2" placeholder="Ketikan kendala jika belum tercapai..."><?php echo e($capaian->analisa_masalah); ?></textarea>
                                    </div>

                                    <div class="mb-4">
                                        <label class="form-label fw-bold text-dark small">Rencana Tindak Lanjut (RTL)</label>
                                        <textarea name="rtl" class="form-control rounded-3 border-0 shadow-sm bg-light" rows="2" placeholder="Ketikan solusi bulan depan..."><?php echo e($capaian->rtl); ?></textarea>
                                    </div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\maganglaravel\resources\views/capaian/edit.blade.php ENDPATH**/ ?>