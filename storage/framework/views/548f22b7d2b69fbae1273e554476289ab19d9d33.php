        ...
        <nav id="sidebar">
            ...
            <ul class="list-unstyled components">
                <li class="<?php echo e(Request::is('dashboard') ? 'active' : ''); ?>">
                    <a href="<?php echo e(route('dashboard')); ?>" title="Dashboard"><i class="fas fa-chart-pie"></i> <span>Dashboard</span></a>
                </li>

                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('kelola_master')): ?>
                <div class="sidebar-heading">Master Data</div>
                
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('kelola_user')): ?>
                <li class="<?php echo e(Request::is('user*') ? 'active' : ''); ?>">
                    <a href="<?php echo e(route('user.index')); ?>" title="User"><i class="fas fa-user-gear"></i> <span>User</span></a>
                </li>
                <?php endif; ?>
                
                <li class="<?php echo e(Request::is('desa*') ? 'active' : ''); ?>">
                    <a href="<?php echo e(route('desa.index')); ?>" title="Desa"><i class="fas fa-house-medical"></i> <span>Desa</span></a>
                </li>
                <li class="<?php echo e(Request::is('klaster*') ? 'active' : ''); ?>">
                    <a href="<?php echo e(route('klaster.index')); ?>" title="Klaster"><i class="fas fa-boxes-stacked"></i> <span>Klaster</span></a>
                </li>
                <li class="<?php echo e(Request::is('program*') ? 'active' : ''); ?>">
                    <a href="<?php echo e(route('program.index')); ?>" title="Program"><i class="fas fa-list-check"></i> <span>Program</span></a>
                </li>
                <li class="<?php echo e(Request::is('indikator*') ? 'active' : ''); ?>">
                    <a href="<?php echo e(route('indikator.index')); ?>" title="Indikator"><i class="fas fa-file-waveform"></i> <span>Indikator</span></a>
                </li>
                <li class="<?php echo e(Request::is('target*') ? 'active' : ''); ?>">
                    <a href="<?php echo e(route('target.index')); ?>" title="Penetapan Target"><i class="fas fa-bullseye"></i> <span>Penetapan Target</span></a>
                </li>
                <?php endif; ?>

                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('kelola_capaian')): ?>
                <div class="sidebar-heading">Data Capaian</div>
                <li class="<?php echo e(Request::is('capaian') || Request::is('capaian/*') && !Request::is('capaian/laporan*') ? 'active' : ''); ?>">
                    <a href="<?php echo e(route('capaian.index')); ?>" title="Input Capaian"><i class="fas fa-file-signature"></i> <span>Input Capaian</span></a>
                </li>
                <li class="<?php echo e(Request::is('laporan/capaian*') ? 'active' : ''); ?>">
                    <a href="<?php echo e(route('capaian.laporan')); ?>" title="Laporan Master"><i class="fas fa-file-contract"></i> <span>Laporan Master</span></a>
                </li>
                <?php endif; ?>

                <li class="mt-5">
                    <a href="<?php echo e(route('logout')); ?>" class="text-danger" title="Keluar">
            ...
            <div class="navbar-custom d-flex justify-content-between align-items-center">
                <div class="d-flex align-items-center">
                    ...
                    <div class="user-profile-nav d-none d-md-flex">
                        <img src="https://ui-avatars.com/api/?name=<?php echo e(Auth::user()->name); ?>&background=D1FAE5&color=059669&bold=true" alt="Avatar">
                        <div class="user-info-text">
                                <i class="fas fa-fingerprint me-1"></i><?php echo e(Auth::user()->username); ?>
                ...
                <div class="d-flex align-items-center gap-3">
                    ...
                    <span class="badge bg-light text-dark text-uppercase p-2 px-3 rounded-pill border shadow-sm"><?php echo e(Auth::user()->role); ?></span>
                </div>
            </div>

            <!-- SweetAlert akan menggantikan alert default ini -->
            <!-- <?php if(session('success')): ?> ... <?php endif; ?> dihapus untuk memakai SweetAlert -->
        ...
        document.addEventListener("DOMContentLoaded", function() {
            ...
            <?php if(session('success')): ?>
                Swal.fire({
                    icon: 'success',
                    title: 'Berhasil!',
                    html: '<?php echo addslashes(session("success")); ?>',
...
</html><?php /**PATH C:\laragon\www\maganglaravel\resources\views/layouts/admin.blade.php ENDPATH**/ ?>