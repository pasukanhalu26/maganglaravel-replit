...
<div class="card border-0 shadow-sm mb-4">
    ...
    <div class="card-body p-4">
        <form action="{{ route('program.index') }}" method="GET" class="mb-4">
            ...
            <table class="table table-hover table-borderless align-middle">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            <span class="badge {{ $p->status == 1 ? 'bg-success' : 'bg-danger' }}">{{ $p->status == 1 ? 'Aktif' : 'Non-Aktif' }}</span>
                        </td>
