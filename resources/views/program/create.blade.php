...
@section('header', 'Tambah Program')
@section('content')
<div class="row justify-content-center">
    <div class="col-md-8">
        <div class="modern-form-card">
            <div class="modern-form-header d-flex justify-content-between align-items-center">
                <h6 class="mb-0"><i class="fas fa-plus-circle me-2"></i>Tambah Program Baru</h6>
            ...
            <div class="modern-form-body">
                <form action="{{ route('program.store') }}" method="POST">
                    ...
                    <div class="form-group mb-4">
                        <label for="id_klaster" class="text-muted small fw-bold mb-1">Pilih Klaster Aktif</label>
                        <select name="id_klaster" id="id_klaster" class="form-select form-select-modern select-searchable" required>
                            <option value="">Pilih Klaster Aktif</option>
                    ...
                    <div class="form-floating mb-4">
                        <input type="text" name="nama_program" id="nama_program" class="form-control form-control-modern" placeholder="Nama Program" required>
