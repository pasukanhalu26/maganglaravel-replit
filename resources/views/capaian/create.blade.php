                                ...
                                <div class="card-body p-4">
                                    ...
                                    <div class="row mb-4">
                                        <div class="col-md-6">
                                            ...
                                            @if($userDesaId)
                                                <input type="hidden" name="id_desa" id="id_desa" value="{{ $userDesaId }}">
                                                <input type="text" class="form-control rounded-3 border-0 shadow-sm bg-light" value="{{ Auth::user()->desa->nama_desa ?? '-' }}" readonly>
                                            @else
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <div class="input-group shadow-sm rounded-3">
                                            ...
                                            <input type="number" name="capaian_bulan" id="capaian_bulan" class="form-control border-0 text-center fw-bold text-primary"
                                                value="{{ old('capaian_bulan', 0) }}" placeholder="0" min="0" required style="font-size: 1.5rem; height: 60px;">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <textarea name="analisa_masalah" class="form-control rounded-3 border-0 shadow-sm bg-light" rows="2" placeholder="Ketikan kendala jika belum tercapai...">{{ old('analisa_masalah') }}</textarea>
                                    </div>
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <textarea name="rtl" class="form-control rounded-3 border-0 shadow-sm bg-light" rows="2" placeholder="Ketikan solusi bulan depan...">{{ old('rtl') }}</textarea>
                                    </div>
